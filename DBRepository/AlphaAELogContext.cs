...
{
    public partial class AlphaAELogContext : DbContext
    {
        ...
        public AlphaAELogContext(DbContextOptions options) : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventHistory>(entity =>
            {
                ...
                entity.Property(e => e.Value).HasColumnName("Attrib00_Value");
